...
export default [
    ...
    importPlugin.flatConfigs.typescript,
    {
        ...
        rules: {
            ...
            'perfectionist/sort-union-types': ['error', { groups: ['conditional', 'function', 'import', 'intersection', 'keyword', 'literal', 'named', 'object', 'operator', 'tuple', 'union', 'nullish', 'unknown'], ignoreCase: true, type: 'alphabetical' }],
    ...
    {
        files: ['test/**', '**/*.test.{js,jsx,ts,tsx}', '**/*.spec.{js,jsx,ts,tsx}'],
    ...
    {
        ignores: ['dist', 'build', 'coverage', 'node_modules', 'public', 'out', 'storybook-static', '.next', '.turbo', '.cache', 'turbo.json', '!.storybook'],
    },
];
